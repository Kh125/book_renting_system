<div class="relative rounded-md">
    <img src="/img/book1.jpg" alt="cover" class="w-[15rem] h-[21rem] rounded-md">
    ...
    {{-- premium --}}
    <div class="flex items-center px-3 py-1 absolute bg-orange-600 text-gray-800 top-0 rounded-br-lg rounded-tl-md">            
